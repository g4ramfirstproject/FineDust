...
public class list {
  ...
  private String jeonnam;
    ...
    public list(String gangwon, String gwangju, String ulsan, String gyeongnam, String chungnam, String daejeon, String daegu, String gyeonggi, String jeonbuk, String chungbuk, String seoul, String busan, String gyeongbuk, String jeju, String jeonnam) {
        this.gangwon = gangwon;
        this.gwangju = gwangju;
        this.ulsan = ulsan;
        this.gyeongnam = gyeongnam;
